...
from techtest.schemas.author_schemas import (
    CreateAuthorRequest,
    UpdateAuthorRequest, 
    AuthorResponse,
    AuthorWithStatsResponse
)
from techtest.core.logger import LoggerMixin, log_database_operation
from techtest.core.exceptions import NotFoundError, AuthorHasArticlesError
